...
const Index = () => (
  <>
    ...
    <p>
      {' '}
      I love to code. I always try to work with something new, so if you know
      any topic, it's normal that I already worked in that subject. (I've worked
      with anything from JAVA and PHP to Mozilla's B2GOS and the linux kernel
      and Assembly code).{' '}
    </p>
    ...
    <p>
      {' '}
      Even though I learnt many things, the subjects I dig into always get
      superposed, but an often SIMPLER, MORE POWERFUL and EASIER alternative.
      That's why I always try to dig into a modern solution for projects, In
      fact, projects I do usually are made with different frameworks, which I
      considered was the best at the time.{' '}
    </p>
  </>
);
