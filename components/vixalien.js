const Logo = (props) => {
  return (
    <svg  viewBox="12.5 50 200 150"
      xmlns="http://www.w3.org/2000/svg" version="1.1" style={{borderRadius: "50%"}} {...props}>
      ...
      <g>
        {/* head */}
    <path d="m 60,100 a 50 50 0 0 1 100 0 l 0,100 l -100,0" fill="url(#head)" />
    ...
    {/* upper lip */}
    <path d="M 82.5 135 c 20 10, 30 10, 50 0" stroke="url(#lips)" fill="transparent" strokeWidth="7" strokeLinecap="round" />
        {/*tooth*/}
    <path d="M 115, 142 l 10,-3 l0,13 l -10,0 z" fill="url(#teeth)" stroke="url(#teeth)" strokeWidth="1" />
    ...
    <filter id="shadow" x="0" y="0" width="200%" height="200%">
          <feDropShadow dx="5" dy="5" stdDeviation="3" floodColor="black" floodOpacity="0.5" />
        </filter>
      </defs>
    </svg>
